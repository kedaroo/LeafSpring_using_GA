...
# from gaeneticalgorithm import geneticalgorithm as ga
# import numpy as np
...
# # def length_of_leaves(d, t, n):

# # 	len_of_leaves = list()
# # 	for i in range(1, int(n)):
# # 		# li = round((((length * 2) / (n - 1)) * i) + l, 2)
# # 		li = (((length * 2) / (n - 1)) * i) + l
# # 		len_of_leaves.append(li)

# # 	# master_leaf = (2 * length) + (2 * math.pi * (d + t))
# # 	# master_leaf = round((2 * length + l) + (2 * math.pi * (d + t)), 2)
...
# # # graduated leaves
# # NG = [i for i in range(2, 16)]

# # # n = nF + nG

# # # assuming all leaves are equally stressed
# # #returns values in mm
# # def thickness_width():
# # 	# calculating thickness
# # 	nbt2 = (6 * load * length) / stress # considering bending stress
# # 	nbt3 = (6 * load * pow(length, 3)) / (E * delta) # considering deflection
# # 	# t = math.ceil(nbt3 / nbt2)
# # 	t = (nbt3 / nbt2)

# # 	# calculating width
# # 	b1 = nbt2 / (n * pow(t, 2)) # rearranging nbt2 equation
# # 	b2 = nbt3 / (n * pow(t, 3)) # rearranging nbt2 equation
# # 	# b = math.ceil(max(b1, b2))
# # 	b = (max(b1, b2))
...
# # 	# Wb = load_on_clip_bolts()
# # 	# clip_load_list.append(Wb)

# # 	d = dia_of_eye(b)
# # 	# eye_diameter_list.append(d)

# # 	s = stress3(nF, nG, b, t)
# # 	stresses.append(s)

# # 	leave_len = length_of_leaves(d, t, n)
# # 	# leave_length.append(leave_len)

# # 	mass = spring_mass(b, t, leave_len)
# # 	masses.append(mass)

# # 	# deflec = deflection2(b, t, nG, nF)
# # 	deflections.append(deflec)


# # print(f'Mass of GA design 1: {mass1}')
# # # print(f'Mass of GA design 1: {de}')
# # print(f'Mass of GA design 2: {mass2}')
# # x = PrettyTable()
# # x.add_column('thickness', thicknesses)
# # x.add_column('width', widths)
# # x.add_column('Mass ', masses)
# # x.add_column('Deflection', deflections)
# # x.add_column('stress', stresses)
# # print(x)
